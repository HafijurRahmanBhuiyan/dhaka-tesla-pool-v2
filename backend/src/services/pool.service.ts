...
export class PoolService {
  ...
  private seedInitialState() {
    ...
    // 3. Seed Jashim's Assigned Tesla Pool: "Bullet" (Gulshan -> Banani -> Mohakhali -> Motijheel)
    const poolJashim: Pool = {
      ...
      seat_capacity: 4,
      available_seats: 1, // 3 booked seats, 1 seat remaining
      status: 'MATCHED',
      corridor_name: 'Gulshan 2 -> Banani -> Mohakhali -> Motijheel C/A',
      origin_zone: 'GULSHAN2',
      destination_zone: 'MOTIJHEEL',
    ...
    // Seed ride requests corresponding to Jashim's pool members
    const rideNusrat: RideRequest = {
      id: 'req-jashim-01',
      passenger_id: 'usr-pass-nusrat',
      passenger_name: 'Nusrat Jahan',
      pickup_zone: 'GULSHAN2',
      pickup_lat: DHAKA_ZONES.GULSHAN2.lat,
      pickup_lng: DHAKA_ZONES.GULSHAN2.lng,
      dropoff_zone: 'MOTIJHEEL',
    ...
    const rideTanvir: RideRequest = {
      id: 'req-jashim-03',
      passenger_id: 'usr-pass-001',
      passenger_name: 'Tanvir Hossain',
      pickup_zone: 'MOHAKHALI',
      pickup_lat: DHAKA_ZONES.MOHAKHALI.lat,
      pickup_lng: DHAKA_ZONES.MOHAKHALI.lng,
      dropoff_zone: 'KAWRANBAZAR',
      dropoff_lat: DHAKA_ZONES.KAWRANBAZAR.lat,
      dropoff_lng: DHAKA_ZONES.KAWRANBAZAR.lng,
      requested_seats: 1,
      status: 'MATCHED',
      fare_bdt: 165.0, // 20% pool discount
      pool_id: 'pool-jashim-bullet',
    ...
    this.rideRequests.set(rideTanvir.id, rideTanvir);
